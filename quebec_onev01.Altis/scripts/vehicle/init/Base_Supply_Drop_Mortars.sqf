...
Base_Supply_Drop_Mortars_StockContainer =
{
	params ["_container"];
...
[_this select 0,
	{
		...
		[_container] call Base_Supply_Drop_Mortars_StockContainer;
		[[_container], Base_Supply_Drop_Mortars_C_SetupActions] remoteExec ["call", 0, true]; // JIP
	}
