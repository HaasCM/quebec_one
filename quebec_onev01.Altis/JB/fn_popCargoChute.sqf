...
{
	private _cargoData = _this select 0;
	private _cargoType = _this select 1;
...
JBPCC_FollowCargoToGround =
{
	...
	private _smokeType = _this select 1;
	private _onLanded = _this select 2;
