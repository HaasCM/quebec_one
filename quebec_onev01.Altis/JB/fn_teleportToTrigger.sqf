...
if (!isNull _destinationTrigger) then
{
	...
	{
		titleText [_destinationMessage, "BLACK IN", 3];
	};

	player setPosASL [_positionX, _positionY, _triggerPosition select 2];

	if (!isNull _destinationDirection) then
	{
