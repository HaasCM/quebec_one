...
Description:
	...
	MissionObjective appears in urban area, with selection of OPFOR Uinfantry, and civilians.
...
//-------------------- BRIEFING
	...
	"sideMarker" setMarkerText "Special Operations Mission: Destroy Weapons Shipment";
	_briefing = "<t align='center'><t size='2.2'>Special Operations Mission</t><br/><t size='1.5' color='#00B2EE'>Destroy Weapons Shipment</t><br/>____________________<br/>The enemy is supplying insurgents with advanced weapons and explosives. Find them and destroy them.</t>";
	[_briefing, getPos SMmission, 60] remoteExec ["AW_fnc_specialOperationsHint", 0, false];
	["NewSideMission", "Destroy Weapons Shipment", getPos SMmission, 60] remoteExec ["AW_fnc_specialOperationsNotification", 0, false];
			
//--------------------- WAIT UNTIL OBJECTIVE COMPLETE: Sent to sabotage.sqf to wait for SM_MissionSucceeded var.

	waitUntil { sleep 3; SM_MissionSucceeded };
