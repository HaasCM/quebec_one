...
private ["_basepos","_continue","_dir","_PTdir","_pos","_barrier","_unitsArray","_flatPos","_accepted","_position","_enemiesArray","_targetList","_fuzzyPos","_x","_briefing","_enemiesArray","_unitsArray","_flatPos1","_flatPos2","_flatPos3","_doTargets","_targetSelect","_targetListEnemy"];
...
while {!_accepted} do {
	...
	if ((_flatPos distance _basepos) > 3000) then {
...

{
	if (typeName _x == typeName objNull && { _x isKindOf "O_APC_Tracked_02_AA_F" }) then
	{
		...
		[_x] spawn { private _vehicle = _this select 0; _vehicle removeMagazines "4Rnd_Titan_long_missiles"; [_vehicle, "missiles_titan", nil, nil, nil, "4Rnd_Titan_long_missiles"] call PRIORITY_ReloadAAWeapon };
	};
...
priorityObj1 addEventHandler ["Fired", { _this call PRIORITY_ReloadAAWeapon } ];
[priorityObj1] spawn { private _vehicle = _this select 0; _vehicle removeMagazines "4Rnd_Titan_long_missiles"; [_vehicle, "missiles_titan", nil, nil, nil, "4Rnd_Titan_long_missiles"] call PRIORITY_ReloadAAWeapon };

priorityObj2 addEventHandler ["Fired", { _this call PRIORITY_ReloadAAWeapon } ];
[priorityObj2] spawn { private _vehicle = _this select 0; _vehicle removeMagazines "4Rnd_Titan_long_missiles"; [_vehicle, "missiles_titan", nil, nil, nil, "4Rnd_Titan_long_missiles"] call PRIORITY_ReloadAAWeapon };

//-------------------- 6b. ABIT OF EXTRA HEALTH

//---------- OBJ 1

private _reducedDamage =
{
...
priorityObj1 addEventHandler ["HandleDamage", _reducedDamage];

//---------- OBJ 2

priorityObj2 setVariable ["selections", []];
priorityObj2 setVariable ["gethit", []];
priorityObj2 addEventHandler ["HandleDamage", _reducedDamage];
...
_briefing = "<t align='center' size='2.2'>Priority Target</t><br/><t size='1.5' color='#b60000'>Anti-Air Battery</t><br/>____________________<br/>OPFOR forces are setting up an anti-air battery.  Intel has picked up their positions with thermal imaging scans and have marked it on your map.<br/><br/>This is a priority target.";
