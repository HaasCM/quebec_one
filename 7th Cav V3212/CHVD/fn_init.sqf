[] spawn {
	...
	player addAction ["<t color='#00FF00'>View Distance Settings</t>", CHVD_fnc_openDialog, [], -99, false, true];

	player addEventHandler ["Respawn", {player addAction ["<t color='#00FF00'>View Distance Settings</t>", CHVD_fnc_openDialog, [], -99, false, true]}];
